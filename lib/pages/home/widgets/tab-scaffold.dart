...
/// behind the tab bar.
///
/// A [tabBar] and a [tabBuilder] are required. The [OBCupertinoTabScaffold]
...
class OBCupertinoTabScaffold extends StatefulWidget {
  ...
  /// [OBCupertinoTabScaffold] automatically also listen to the
  /// [CupertinoTabBar]'s `onTap` to change the [CupertinoTabBar]'s `currentIndex`
  /// and change the actively displayed tab in [OBCupertinoTabScaffold]'s own
  /// main content area.
  ///
  ...
  @override
  _OBCupertinoTabScaffoldState createState() => _OBCupertinoTabScaffoldState();
}
