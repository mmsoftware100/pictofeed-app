                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          OBTextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText:
                                  _localizationService.user__edit_profile_name,
                          ...
                          OBTextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelText:
                                  _localizationService.user__edit_profile_url,
                            ),
                          ),
                          OBTextFormField(
                          ...
                          OBTextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText:
                                  _localizationService.user__edit_profile_bio,
        ...
        builder: (BuildContext context) {
          List<Widget> listTiles = [
            new ListTile(
              ...
              onTap: () async {
                try {
                  var image = await _imagePickerService.pickImage(imageType: imageType, context: context);
            ...
            case OBImageType.cover:
              if (_coverUrl != null || _coverFile != null) {
                listTiles.add(ListTile(
                  ...
                  title:
                      new Text(_localizationService.user__edit_profile_delete),
                  onTap: () async {
                    _clearCover();
                    Navigator.pop(context);
                  },
